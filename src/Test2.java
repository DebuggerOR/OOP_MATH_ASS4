...
public class Test2 {
    public static void main(String args[]) throws Exception {
        ...
        //e = new Div(new Plus(new Plus("x", new Log(2, new Plus("x", "y"))), "z"), new Plus("z", new Plus(new
              //  Log(2, new Plus("y", "x")), "x")));
        e = new Div(new Plus(new Plus("x", "y"), "z"), new Plus("z", new Plus("y", "x")));
